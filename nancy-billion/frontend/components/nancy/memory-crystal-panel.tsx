          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {memoryCrystals.map((crystal, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center"
                    ...
                    <div className="w-6 h-6 bg-white/10 rounded-full border border-white/20 flex items-center justify-center">
              ...
              {(() => {
                ...
                memoryCrystals.forEach((crystal1, i1) => {
                  memoryCrystals.forEach((crystal2, i2) => {
                    if (i1 >= i2) return
                    const shouldConnect = crystal1.clarity > 70 && crystal2.clarity > 70
                    if (!shouldConnect) return
                    const pos1 = {
                      x: Math.cos((i1 / memoryCrystals.length) * Math.PI * 2) * (80 + (crystal1.clarity / 100) * 20),
                      y: Math.sin((i1 / memoryCrystals.length) * Math.PI * 2) * (80 + (crystal1.clarity / 100) * 20),
                    }
                    const pos2 = {
                      x: Math.cos((i2 / memoryCrystals.length) * Math.PI * 2) * (80 + (crystal2.clarity / 100) * 20),
                      y: Math.sin((i2 / memoryCrystals.length) * Math.PI * 2) * (80 + (crystal2.clarity / 100) * 20),
                    }
                    connections.push(
                      <div
                        key={`conn-${crystal1.id}-${crystal2.id}`}
                        className="absolute"
                        style={{
                          ...
                          height: '1px',
                          background: 'linear-gradient(to right, transparent, rgba(56,211,235,0.4), transparent)',
                ...
                return <div className="absolute inset-0 pointer-events-none">{connections}</div>
              })()}
            </div>
          </div>
        </div>
