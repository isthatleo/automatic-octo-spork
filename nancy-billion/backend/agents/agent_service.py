...
_ROUTE_RULES: List[tuple[list[str], str]] = [
    ...
    (["devops", "deploy", "docker", "kubernetes", "ci/cd", "pipeline", "infra",
      "git status", "git log", "git diff", "git commit", "git push", "git pull",
      "github", "pull request", "commit this", "push this", "my repo"],        "devops"),
    ...
    (["weather", "forecast", "temperature outside", "rain", "storm", "climate", "heat index", "wind chill"], "weather_climate"),
    (["gdp", "inflation", "unemployment rate", "macroeconomic", "economic indicator", "world bank", "economy"], "economics"),
    (["material", "alloy", "polymer", "ceramic", "composite", "tensile", "yield strength", "thermal expansion"], "materials_science"),
    (["budget", "savings plan", "retirement", "debt payoff", "net worth", "personal finance"], "personal_finance"),
    (["solar panel", "wind turbine", "lcoe", "renewable energy", "grid carbon", "battery storage", "power grid"], "energy_grid"),
    (["prime number", "factorize", "gcd", "lcm", "combinatorics", "polynomial", "eigenvalue", "linear algebra", "fibonacci"], "mathematics"),
    ...
    (["convert time zone", "timezone", "meeting overlap", "working hours overlap",
      "what time is it", "what's the time", "whats the time", "current time",
      "what day is it", "what's today's date", "whats todays date", "current date",
      "time is it in", "time in tokyo", "time in london", "time zone in"], "timezone_scheduling"),
